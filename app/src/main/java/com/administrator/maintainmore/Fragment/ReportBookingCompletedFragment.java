...
public class ReportBookingCompletedFragment extends Fragment implements ServiceReportAdapter.ViewHolder.OnServiceReportCardChickListener {

    private static final String TAG = "ReportBookingCompletedFragmentInfo";

    RecyclerView recyclerView_serviceReport;

    FirebaseFirestore db;

    public ReportBookingCompletedFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        db.collection("Bookings Completed").addSnapshotListener((value, error) -> {
    ...
    public void onServiceCardClickListener(int position) {
        ...
        intent.putExtra("tableName", "Bookings Completed");
